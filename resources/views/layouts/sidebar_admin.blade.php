<aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        ...
        <div>
            <h4 class="logo-text">Assistant4U</h4>
        </div>
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="{{ route('admin.manage_staffs') }}">
                <div class="parent-icon"><i class="bi bi-person-fill-gear"></i></div>
                <div class="menu-title">Working Staff</div>
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="{{ route('provinces') }}">
                ...
                <div class="menu-title">Provinces</div>
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="{{ route('job_services') }}">
                <div class="parent-icon"><i class="bi bi-briefcase-fill"></i></div>
                <div class="menu-title">Job Services</div>
            </a>
        </li>
        <li>
            <a href="{{ route('admin.complaints') }}">
                <div class="parent-icon"><i class="bi bi-exclamation-circle-fill"></i>
                </div>
